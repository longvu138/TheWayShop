                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            ...
                            <ul>
                                <li>
                                    <p> Cs1: 1 Tôn Thất Tùng, Đống Đa, Hà Nội </p>
                                </li>
                                <li>
                                    <p> Cs2: 378 Đường Láng, Láng Hạ, Đống Đa</p>
                                </li>
                                <li>
                                    <p> Cs3: 300 Lê Trọng Tấn, Thanh Xuân, Hà Nội</p>
                                </li>
                                <li>
                                    <p> Cs4: 36 Đường Cầu Giấy, Quan Hoa, Cầu Giấy, Hà Nội</p>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="footer-copyright">
        <p class="footer-company"> &copy ThewayShop</a> </p>
