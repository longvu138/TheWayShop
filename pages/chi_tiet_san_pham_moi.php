            ...
            <div class="row">
                ...
                while($row = mysqli_fetch_array($noi_dung_san_pham_moi)) {
                    ;?>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="<?php echo $row['anh_minh_hoa_1'] ? 'images/'.$row['anh_minh_hoa_1'] : 'images/img-pro-01.jpg' ;?>" alt="First slide"> </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2><?php echo $row["ten_san_pham_moi"];?></h2>
                        <h5> <del><?php echo $row["gia_ban"];?></del> <?php echo $row["gia_ban_giam"];?></h5>
                        <p class="available-stock"><span>Số lượng còn <?php echo $row["so_luong"];?> / <a href="#">8 sold </a></span>
                            <p>
                                <h4>Mô tả sản phẩm</h4>
                                <p><?php echo $row["mo_ta_san_pham"];?> </p>
                                <form method="POST" action="gio_hang.php" action="thanh_toan.php" enctype="multipart/form-data">
                                <ul>    
                                    <li>
