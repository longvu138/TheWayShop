                    ...
                    <form class="mt-3 collapse review-form-box" id="formLogin">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" id="InputPassword" placeholder="Mật khẩu"> </div>
                        </div>
                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="InputName" placeholder="Họ"> </div>
                            <div class="form-group col-md-6">
                                <label for="InputLastname" class="mb-0">Tên</label>
                                <input type="text" class="form-control" id="InputLastname" placeholder="Tên"> </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" id="InputPassword1" placeholder="Mật khẩu"> </div>
                        </div>
                        <button type="submit" class="btn hvr-hover">Tạo mới</button>
                    </form>
                </div>
            </div>
                    ...
                    <div class="checkout-address">
                        ...
                        <form class="needs-validation" novalidate>
                            <div class="mb-3">
                                ...
                                <input type="text" name="hoten" class="form-control" id="address" placeholder="Họ và tên" required>
                            </div>
                            <div class="mb-3">
                                <label for="address">Địa chỉ *</label>
                                <input type="text" name="diachi" class="form-control" id="address" placeholder="" required>
...
<!--                             <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="address2">Tỉnh/Thành phố *</label>
                                <input type="text" class="form-control" fadeInDown="address2" placeholder=""> </div> -->
                            <div class="mb-3">
                                <label for="address2">Số điện thoại *</label>
                                <input type="text" name="sdt" class="form-control" id="address2" placeholder=""> </div>
                            <hr class="mb-4">
