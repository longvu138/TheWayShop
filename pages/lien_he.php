        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="trangchu.php"><img src="images/logo.png" class="logo" alt=""></a>
                </div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><i class="fab fa-facebook"></i>Fanpage:<a href="https://www.facebook.com/thewayshop">https://www.facebook.com/thewayshop</a></p>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>Giới thiệu Wind Sneaker</h4>
                            <p>Shop giày Wind Sneaker chuyên cung cấp giày Snearker. Với dòng sản phẩm đạt chất lượng cao, rep 1:1, rep+. Mọi người liên hệ SHop ngay để được nhân viên tư vấn.
                                </p>
                            <ul>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><i class="fab fa-facebook"></i>Fanpage:<a href="https://www.facebook.com/windstore.sneakers">https://www.facebook.com/thewayshop</a></p>
                                </li>
                                <li>
                                <p><i class="fab fa-instagram"></i>Instagram:https://www.instagram.com/thewayshop/<a href="#"></a></p>
                            </li>
