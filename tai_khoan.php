                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="san_pham.php">Jackets</a></li>
                                                    <li><a href="san_pham.php">Shirts</a></li>
                                                    <li><a href="san_pham.php">Sweaters & Cardigans</a></li>
                                                    <li><a href="san_pham.php">T-shirts</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="san_pham.php">Swimwear</a></li>
                                                    <li><a href="san_pham.php">Skirts</a></li>
                                                    <li><a href="san_pham.php">Jeans</a></li>
                                                    <li><a href="san_pham.php">Trousers</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="san_pham.php">Top Wear</a></li>
                                                    <li><a href="san_pham.php">Party wear</a></li>
                                                    <li><a href="san_pham.php">Bottom Wear</a></li>
                                                    <li><a href="san_pham.php">Indian Wear</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="san_pham.php">Bags</a></li>
                                                    <li><a href="san_pham.php">Sunglasses</a></li>
                                                    <li><a href="san_pham.php">Fragrances</a></li>
                                                    <li><a href="san_pham.php">Wallets</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
