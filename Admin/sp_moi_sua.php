                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="san_pham_moi.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Cập nhật sản phẩm mới</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="sp_moi_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Tên sản phẩm mới" name="txtTensanphammoi" value="<?php echo $row["ten_san_pham_moi"];?>"/>
                                                <label for="inputEmail">Tên sản phẩm mới</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                             ...
                                             <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Giá bán" name="txtGiaban" value="<?php echo $row["gia_ban"];?>" />
                                                <label for="inputEmail">Giá bán</label>
                                            </div>
                                            
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value="<?php echo $row["id_san_pham_moi"];?>">
