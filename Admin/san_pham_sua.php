                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="San_pham_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Tên sản phẩm" name="txtTensanpham" value="<?php echo $row["ten_san_pham"];?>"/>
                                                <label for="inputEmail">Tên sản phẩm</label>
                                            </div>
                                            <!-- <div class="form-floating mb-3">
                                                <div class="form-control" id="txtAnhminhhoa" type="file" placeholder="Ảnh minh họa" name="txtAnhminhhoa" value="<?php echo $row["anh_minh_hoa"];?>"></div>
